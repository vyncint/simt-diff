//! ORACLE: KNOWN_UNSAFE (RC001). Only the even lanes reach the barrier.
//! This is byte-for-byte reconverge's canonical sample kernel.
use cuda_core::{CudaContext, DeviceBuffer, LaunchConfig};
use cuda_device::{DisjointSlice, cuda_module, kernel, thread};

const KERNEL: &str = "probe_divergent_barrier";
